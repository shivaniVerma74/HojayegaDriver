  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("TermsCondition", style: TextStyle(color:  Colors.white),),
        centerTitle: true,
        toolbarHeight: 60,
        elevation: 6,
      ...
      body: ListView(
        children: [
          Padding(
            ...
            child: Text("${termsConditionsTitle}",style: TextStyle(fontSize: 16,color: colors.black,fontWeight: FontWeight.bold),),
          ),
