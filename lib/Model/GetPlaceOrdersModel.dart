...
class GetPlaceOrdersModel {
  ...
  GetPlaceOrdersModel.fromJson(dynamic json) {
    _error = json['error'];
    _message = json['message'];
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(PlaceOrderData.fromJson(v));
      });
    }
  }
  bool? _error;
  String? _message;
  List<PlaceOrderData>? _data;
GetPlaceOrdersModel copyWith({  bool? error,
  String? message,
  List<PlaceOrderData>? data,
}) => GetPlaceOrdersModel(  error: error ?? _error,
  message: message ?? _message,
  data: data ?? _data,
);
  bool? get error => _error;
  String? get message => _message;
  List<PlaceOrderData>? get data => _data;
...
/// pickup_name : "asdfasdfsda"
/// pickup_number : "7898989"
/// pick_zone : "teaafdasfadsf"
/// time_slot : "yes"
/// vehicle_type : "2"
/// product_type : "1"
/// product_description : "tesatasdfasd"
/// note : "afdasdfasdfasdf"
/// reciever_id : "10,11"
/// created_at : "2023-11-18 18:48:33"
/// user_id : "1"
/// image : "656083676f5d9.JPG"
/// amount : "60"
/// payment_type : "CASH"
/// from_time : "16:37"
/// to_time : "18:37"
...
/// friend_code : ""
/// parcel_order_id : "30"
/// drop_location : "469, Khajrana, Indore, Madhya Pradesh 452016, India"
/// drop_name : "raj"
/// drop_number : "78788"
/// drop_address : "8887878998"
/// drop_zone : "Tearasdfsdf"
/// creat_date : "2023-11-24 16:35:11"
/// km : "8.8 km"
/// delivery_charge : "30"
/// drop_latitude : "22.7613248"
/// drop_longitude : "75.9082275"
...
class PlaceOrderData {
  ...
  PlaceOrderData copyWith({  String? id,
  String? pickupLocation,
  String? pickupAddress,
  String? latitude,
  String? longitude,
