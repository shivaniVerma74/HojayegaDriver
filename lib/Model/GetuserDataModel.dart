...
class GetuserDataModel {
  ...
  GetuserDataModel.fromJson(dynamic json) {
    _status = json['status'];
    _msg = json['msg'];
    _setting = json['setting'] != null ? UserData.fromJson(json['setting']) : null;
  }
  num? _status;
  String? _msg;
  UserData? _setting;
GetuserDataModel copyWith({  num? status,
  String? msg,
  UserData? setting,
}) => GetuserDataModel(  status: status ?? _status,
  msg: msg ?? _msg,
  setting: setting ?? _setting,
);
  num? get status => _status;
  String? get msg => _msg;
  UserData? get setting => _setting;
